...
#define MAX_JSON_TOKENS 128 // Максимальное количество элементов в JSON-сообщении
#define MAX_JSON_RESPONSE_LEN 256 // Максимальная длина JSON ответа

// Максимальное количество шагов в одном "рецепте"

#define MAX_STEPS_PER_JOB 20

#define CMD_BUFFER_LEN 32
#define REQ_ID_BUFFER_LEN 32
